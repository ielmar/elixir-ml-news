defmodule ElixirMLNewsWeb.FeedLive.Index do
  use ElixirMLNewsWeb, :live_view

  @impl true
  def mount(_params, _session, socket) do
    articles = ElixirMLNews.Stream.connect(self())
  ...
  defp do_ner_enrich(socket, articles) do
    ner_task =
      Task.async(fn ->
        ...
        ignore ++ ElixirMLNews.Enrichments.NER.predict(enrich)
      end)
  ...
  defp do_sentiment_enrich(socket, articles) do
    sentiment_task =
      Task.async(fn ->
        ...
        ignore ++ ElixirMLNews.Enrichments.Sentiment.predict(enrich)
      end)
